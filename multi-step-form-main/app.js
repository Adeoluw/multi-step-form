...
infoNextButton.addEventListener("click", () => {
  ...
  selectionCon.appendChild(nextPrev)
...
// Create an eventlistener for the previous button
...
summaryCon.className = "remove-selection-visibility";
  ...
  ////////////////////////////////////////////////////////////////////////////////// create an eventlistener for the next button
...
let nextPrev = document.createElement("div");
nextPrev.className = "next-prev-con";
summaryCon.appendChild(nextPrev);
...
// create an eventhandler for the previous button
previousButton.addEventListener("click", () => {
addOnCon.className = "add-addon-visibility";
infoSection.className = "remove-info-visibility";
selectionCon.className = "remove-selection-visibility";
...
//////////////////////////////////////////////////////////////////////////////// End of the next evennt handler
...
// create even listener for the previous button inside the summary sectionnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn
previousButton.addEventListener("click", () => {
  addOnCon.className = "add-addon-visibility";
    infoSection.className = "remove-info-visibility";
    selectionCon.className = "remove-selection-visibility";
...
nextPrev.appendChild(nextButton)
  ...
  // summaryCon.className = "add-addon-visibility";
      ...
      ////////////////////////////////////////////////////////////////////// End of eventlistener for the next button
    hasAddOnEventOccurred = true;
  }
